...
def rounding(massive_in):
    massive_out = [round(item, 3) for item in massive_in]
    return massive_out
...
def dice_error_count(a, b, c, m):
    ...
    print('SE: ', rounding(st_dev))
    print('SEM: ', rounding(st_dev_mean))
    print('Full error: ', rounding(st_full_error))
    ...
    student_function = (density - table_density)/ error_density
